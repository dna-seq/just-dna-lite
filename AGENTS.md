...
- Paper 1 now includes ecosystem infrastructure beyond the local app: `just-dna-format` (https://github.com/dna-seq/just-dna-format) is the standalone annotation module schema/manifest/integrity contract and reference compiler, and `just-dna-marketplace` (https://github.com/dna-seq/just-dna-marketplace) is the catalog/publish/download REST API for annotation modules. Include both in Paper 1 architecture and code-availability discussions.
